...
public class Main {
    ...
    private static void tests(String url, boolean disableSSL, String username, String password) throws Exception {
...
//            //// END TEST 1 ////
            ...
            // Establish URLConnection object with base URL.
            URLConnection connection = new URLConnection(url, true,
                    "igc.api.user", "igc.api.user");
            // Call the GET method for the object, appending the base URL (with specifics).
...
//            IGCItemList itemList14 = connection.searchIGCResourceModifiedBetween((curTime - 604800000L), curTime);
//            //Print results
